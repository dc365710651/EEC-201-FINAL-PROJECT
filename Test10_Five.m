function Test10_Five()
    % Test9_Five:
    % Speaker recognition for word "Five."

    baseTrainPath = '/Users/solemnity/Documents/EEC 201/Final_Project/GivenSpeech_Data/Five_Training_Data';
    baseTestPath  = '/Users/solemnity/Documents/EEC 201/Final_Project/GivenSpeech_Data/Five_Test_Data';
    ...
    for spk = 1:numSpeakers
        ...
        fprintf('Five-Word: s%d.wav => recognized as Speaker %d\n', spk, predictedSpk);
        if predictedSpk == spk
    ...
    fprintf('Test10_Five: Accuracy for "Five" across 23 speakers = %.2f%%\n', accuracy);
end
